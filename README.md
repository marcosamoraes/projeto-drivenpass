# drivenpass-back-prisma

Back-end for DrivenPass, an password management solution.

## About

DrivenPass is a web browser application with which you can store all your passwords with security.
...
Set `POSTGRES_HOST` to `drivenpass-postgres-development` for `.env.development` and `drivenpass-postgres-test` for `.env.test` file. It is the name of the postgres container inside docker-compose file. Docker Compose will start the postgres container for you, create the database and host alias for you.
